// mantenimiento/page.tsx - Optimizado para móvil

'use client'
import { useState, useMemo, useCallback, useEffect } from 'react'
import { OrdenMantenimiento } from '@/types/orden'
import { Plus, Search, Eye, Printer, ArrowLeft, Wrench, Filter, ChevronDown, ChevronUp, X } from 'lucide-react'
        ...
        <div className="bg-gray-800/50 rounded-xl border border-gray-700/50 overflow-hidden">
          ...
          {loading && todasLasOrdenes.length === 0 ? (
            ...
            <EmptyState 
              ...
              onCreateNew={() => setMostrarFormulario(true)} 
            />
          ) : (
            <>
              {/* Vista móvil: Cards */}
