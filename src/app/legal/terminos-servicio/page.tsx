      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <header className="space-y-4">
          <div className="w-16 h-16 bg-blue-600/20 rounded-2xl flex items-center justify-center">
            <FileText className="w-8 h-8 dark:text-blue-400 text-blue-700" />
          </div>
        ...
        <section className="space-y-6 dark:text-gray-300 text-gray-700 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">1. Uso de la Plataforma</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">2. Responsabilidad sobre Equipos</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">3. Órdenes de Servicio y Firmas</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">4. Propiedad Intelectual</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">5. Modificaciones</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">6. Ley Aplicable</h2>
          <p>
