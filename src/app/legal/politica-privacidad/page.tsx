...
export default function PoliticaPrivacidad() {
  return (
    <div className="min-h-screen dark:bg-gray-900 bg-gray-100 text-gray-100 p-6 sm:p-12">
      <div className="max-w-3xl mx-auto space-y-8">
        <Link 
          href="/login"
          className="inline-flex items-center dark:text-blue-400 text-blue-700 hover:dark:text-blue-300 hover:text-blue-700 transition-colors"
        >
        ...
        <header className="space-y-4">
          <div className="w-16 h-16 bg-blue-600/20 rounded-2xl flex items-center justify-center">
            <Shield className="w-8 h-8 dark:text-blue-400 text-blue-700" />
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold">Política de Privacidad</h1>
          <p className="dark:text-gray-400 text-gray-600 italic">Última actualización: 10 de junio de 2026</p>
        </header>

        <section className="space-y-6 dark:text-gray-300 text-gray-700 leading-relaxed">
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">1. Responsable del Tratamiento</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">2. Datos Recolectados</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">3. Finalidad del Tratamiento</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">4. Derechos de los Titulares</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">5. Seguridad de la Información</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold dark:text-white text-gray-900">6. Contacto</h2>
          <p>
        ...
        <footer className="pt-12 border-t dark:border-gray-800 border-gray-200 text-center text-sm text-gray-500">
