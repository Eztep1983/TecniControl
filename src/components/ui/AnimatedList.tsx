    ...
    <div className={`relative w-full ${className}`}>
      <div
        ...
        className={`max-h-[600px] overflow-y-auto p-2 ${
          displayScrollbar
            ? '[&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-600/50 [&::-webkit-scrollbar-thumb]:rounded-[4px]'
            : 'scrollbar-hide'
        }`}
      ...
      {showGradients && (
        <>
          <div
            className="absolute top-0 left-0 right-0 h-[30px] bg-gradient-to-b from-gray-900/80 to-transparent pointer-events-none transition-opacity duration-300 ease z-10"
            style={{ opacity: topGradientOpacity }}
          ></div>
          <div
            className="absolute bottom-0 left-0 right-0 h-[50px] bg-gradient-to-t from-gray-900/80 to-transparent pointer-events-none transition-opacity duration-300 ease z-10"
