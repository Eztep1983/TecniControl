      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-xl bg-gray-50 overflow-hidden relative" style={{ height: 200 }}>
              <SignatureCanvas
                ref={sigCanvas}
                penColor="black"
          ...
          <div className="flex items-start bg-blue-50 p-4 rounded-xl border border-blue-100">
            ...
            <label htmlFor="validacionCliente" className="ml-3 block text-sm text-blue-900 cursor-pointer">
